...
for f in infiles:
	...
	counter_PoorQuality, counter_NoRepeats, counter_AbnormalRepeatLength, counter_LowIdentity, counter_ConsensusSequences, counter_TotalReads, counter_RepeatLengths = Consensus(infile, outfile, W, Tmm)
	infile.close()
